function I= trapecios2D (f,a,b,n,c,d,m)
% I=trapecios2D(f,a,b,n,c,d,m) obtiene la integral de f(x,y)
...
pesos_n = [1 2*ones(1,n -1) 1]; %pesos asociados a primera variable
pesos_m = [1 2*ones(1,m -1) 1]; %pesos asociados a segunda variable
