function [nodos, solAprox,t, iter]=disparo_secante_NoDirich(f,a,b,alfa,beta,N,tol,maxiter)
...
while incre>tol && iter<maxiter
    t=t1-(t1-t0)*(yb1+yp1-beta)/(yb1+yp1-yb0-yp0); %t=t1-(t1-t0)*F(t1)/(F(t1)-F(t0))
