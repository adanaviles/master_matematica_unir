function [X,Y,iter,incr]=Difnolin_NoDirich_monse(f,fy,fz,a,b,alfa,beta,N,maxiter,tol) 
...
while incr>tol && iter<maxiter
    z=[(alfa-Y(1))/2 (Y(3:N+2)-Y(1:N))/(2*h) (Y(N+2)-beta)/2]; % Estimacion de la derivada por diferencias
    % centrales
