...
xaxis_7 = linspace(xi(7),xi(8));
% Definimos los y1,y2... para graficar.
yaxis_1 = double(subs(p(1), x, xaxis_1));
yaxis_2 = double(subs(p(2), x, xaxis_2));
yaxis_3 = double(subs(p(3), x, xaxis_3));
yaxis_4 = double(subs(p(4), x, xaxis_4));
yaxis_5 = double(subs(p(5), x, xaxis_5));
yaxis_6 = double(subs(p(6), x, xaxis_6));
yaxis_7 = double(subs(p(7), x, xaxis_7));

plot(xi,fi,'o');
hold on;
plot(xaxis_1,yaxis_1);
plot(xaxis_2,yaxis_2);
plot(xaxis_3,yaxis_3);
plot(xaxis_4,yaxis_4);
plot(xaxis_5,yaxis_5);
plot(xaxis_6,yaxis_6);
plot(xaxis_7,yaxis_7);
hold off;
